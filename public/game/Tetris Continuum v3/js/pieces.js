...
let colors=["#a000f0", "#0000f0", "#f0a000", "#00f000", "#f00000", "#00f0f0", "#f0f000"];


function randomFallingPiece(){
    let num_piece = Math.floor(Math.random()*patternList.length);
...
class Piece{
    ...
    draw(ctx){
        ...
        this.pattern.drawAt(ctx, this.pos, 0);//padding);
    }
    clear(ctx){
